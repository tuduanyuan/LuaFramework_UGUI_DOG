...
namespace XGame
{
    public class LinesGR : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            AddLine(ml, MakeQuad(new Vector3(10, 1, 0), new Vector3(10, 1, 0), lineSize),false);
        }
        void Update1()
        {
        ...
        void Update()
        {
            ...
            {
                var input = GetNewPoint();
                s = transform.InverseTransformPoint(input);
                logger.debug("input:" + input + "s:" + s);
            }
