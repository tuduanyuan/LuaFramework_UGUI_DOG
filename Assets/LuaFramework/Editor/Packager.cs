...
public class Packager {
    ...
    static void HandleExampleBundle() {
        ...
        //我自己添加的
        AddBuildMap("hello" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Builds/Hello");
        AddBuildMap("main" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Builds/Main");
        AddBuildMap("gamectrl" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Builds/GameCtrl");
    }
