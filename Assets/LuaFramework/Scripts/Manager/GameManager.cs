...
namespace LuaFramework {
    public class GameManager : Manager {
        ...
        IEnumerator OnUpdateResource() {
            ...
            logger.warn("LoadUpdate---->>>" + listUrl);
        ...
        void OnInitialize() {
            ...
            logger.debug("TestObjectClass--->>>" + testObj1.ToString());
            ...
            logger.debug("TestGameObject--->>>" + backObj);
        }
        ...
        void OnPoolGetElement(TestObjectClass obj) {
            logger.debug("OnPoolGetElement--->>>" + obj);
        }
        ...
        void OnPoolPushElement(TestObjectClass obj) {
            logger.debug("OnPoolPushElement--->>>" + obj);
        }
        ...
        {
            LuaManager.OnLevelLoaded(scene.buildIndex);
            PanelManager.OnLevelLoaded(scene.buildIndex);
        }
#else
        protected void OnLevelWasLoaded(int level)
        {
            LuaManager.OnLevelLoaded(level);
            PanelManager.OnLevelLoaded(level);
        }
#endif
