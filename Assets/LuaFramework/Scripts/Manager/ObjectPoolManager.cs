    ...
    public class ObjectPoolManager : Manager {
        ...
        public GameObject Get(string poolName) {
            ...
            if (m_GameObjectPools.ContainsKey(poolName)) {
                ...
                if (result == null) {
                    logger.warn("No object available in pool. Consider setting fixedSize to false.: " + poolName);
                }
            } else {
                logger.error("Invalid pool name specified: " + poolName);
            }
            return result;
        }
        ...
        public void Release(string poolName, GameObject go) {
            if (m_GameObjectPools.ContainsKey(poolName)) {
                ...
                logger.warn("No pool available with name: " + poolName);
            }
        }
