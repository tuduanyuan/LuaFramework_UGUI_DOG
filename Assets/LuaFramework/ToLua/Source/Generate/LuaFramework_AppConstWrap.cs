...
public class LuaFramework_AppConstWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("PERSISTENT_DATA_PATH", get_PERSISTENT_DATA_PATH, null);
		L.RegVar("PersistentLogPath", get_PersistentLogPath, null);
		L.RegVar("PersistentDataPath", get_PersistentDataPath, null);
		L.RegVar("FrameworkRoot", get_FrameworkRoot, null);
		L.RegVar("ProjectPath", get_ProjectPath, null);
		L.EndClass();
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_PERSISTENT_DATA_PATH(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.PERSISTENT_DATA_PATH);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_PersistentLogPath(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.PersistentLogPath);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_PersistentDataPath(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.PersistentDataPath);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_ProjectPath(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.ProjectPath);
			return 1;
		}
		catch (Exception e)
		{
